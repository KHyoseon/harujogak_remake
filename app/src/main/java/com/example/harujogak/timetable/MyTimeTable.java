package com.example.harujogak.timetable;
...
public class MyTimeTable {
    ...
    public void setPieData(PieData p) {
        pieData = p;
    }
    ...
    public void setMyBackground(ArrayList<Integer> background) {
    ...
    public ArrayList<Integer> getMyBackground() {
        return MyBackground;
    }
